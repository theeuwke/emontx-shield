...
{
  SerialUSB.print(realPower);
  SerialUSB.print(' ');
  SerialUSB.print(apparentPower);
  SerialUSB.print(' ');
  SerialUSB.print(Vrms);
  SerialUSB.print(' ');
  SerialUSB.print(Irms);
  SerialUSB.print(' ');
  SerialUSB.print(powerFactor);
  SerialUSB.println(' ');
  delay(100);
}
...
long EnergyMonitor::readVcc() {
  ...
  result = ADCL;
  result |= ADCH<<8;
  result = READVCC_CALIBRATION_CONST / result;  //1100mV*4096 ADC steps http://openenergymonitor.org/emon/node/1186
  return result;
